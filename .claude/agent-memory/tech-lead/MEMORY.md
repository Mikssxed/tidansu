...
- [Plan-cap check-then-insert race](arch_plan-cap-check-then-insert-race.md) — non-atomic cap gate; fix = per-user sp_getapplock re-count-in-lock keeping PlanPolicy in Application, not a DB constraint (B-12; siblings B-13..B-19)
