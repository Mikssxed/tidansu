...
- [Kiota regen via build-time OpenAPI](tooling_kiota-regen-build-time-openapi.md) — B-21: ApiDescription.Server (HostFactoryResolver, like dotnet ef) not the Swashbuckle CLI; don't add AddOpenApi; gen runs as Development
