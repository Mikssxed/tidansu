...
gate**. Do not skip a gate. Do not run the next stage until the artifact from
the previous stage exists and the human has approved it.
...
> `.pi/agents/README.md`). Running *this* session on **Sonnet** (`/model
