...
// @ts-ignore
import { createProblemDetailsFromDiscriminatorValue, createSpaceDtoApiOperationResultFromDiscriminatorValue, type ProblemDetails, type SpaceDtoApiOperationResult } from '../../../models/index.js';
// @ts-ignore
