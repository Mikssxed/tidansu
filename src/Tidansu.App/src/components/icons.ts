/*
 * Line-icon path data (Lucide/Tabler style, stroke = currentColor), ported from
 * the design bundle's icons.jsx. Rendered by BaseIcon as a single <path>.
 */
export const ICON_PATHS = {
    ...
    sparkle:
        'M12 3l1.8 4.9L18.7 9l-4.9 1.8L12 15l-1.8-4.2L5.3 9l4.9-1.1zM18 14l.8 2.2 2.2.8-2.2.8L18 20l-.8-2.2-2.2-.8 2.2-.8z',
    ...
    floor: 'M3 16h18M6 16l1.6-7h8.8l1.6 7',
